...
export function IntroSection() {
  ...
  // Spinning background rotation on scroll - VERY fast spin, starts immediately
  const bgRotate = useTransform(scrollYProgress, [0, 0.5], [0, 360])
  const bgScale = useTransform(scrollYProgress, [0, 0.5], [1.2, 2.0])
  ...
  if (isMobile) {
    return (
      <section id="home" ref={sectionRef} className="relative w-full min-h-screen h-[100dvh] overflow-hidden bg-[#0A4D3C]">
