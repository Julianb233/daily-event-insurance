    ...
    <>
      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-700">
        <Link href="/hiqor/dashboard" className="flex items-center gap-2">
          ...
          <div>
            <span className="font-bold text-slate-900 dark:text-white">HIQOR Portal</span>
      ...
      {/* User info */}
      <div className="p-4 mx-4 mt-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl">
        ...
        <div className="mt-3 pt-3 border-t border-indigo-200 dark:border-indigo-700">
          <span className="inline-flex items-center px-2 py-1 bg-indigo-100 dark:bg-indigo-800 text-indigo-700 dark:text-indigo-200 text-xs font-medium rounded-full">
