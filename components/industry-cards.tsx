      ...
      <Link href={`/industries/${industry.slug}`} className="block">
        ...
        >
          ...
          <div className="relative h-full bg-white/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-premium border border-gray-100/80 hover:shadow-premium-hover transition-shadow duration-500 overflow-hidden">
            ...
            {/* Icon Container */}
            <div className="mb-6 relative flex justify-center md:justify-start" style={{ transform: "translateZ(20px)" }}>
            ...
            {/* Content */}
            <div className="mb-6 text-center md:text-left" style={{ transform: "translateZ(10px)" }}>
            ...
            {/* Learn More CTA */}
            <motion.div
              className="flex items-center justify-center md:justify-start gap-2 text-teal-600 font-semibold text-sm md:text-base"
