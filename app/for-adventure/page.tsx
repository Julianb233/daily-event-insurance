    ...
    <main className="relative overflow-x-hidden max-w-full bg-white">
      ...
      <section id="demo" className="py-20 md:py-32 bg-teal-900">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black uppercase text-white mb-6">
              Ready to <span className="text-teal-400">Start?</span>
            </h2>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 px-10 py-5 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-teal-500/30"
            >
              Start Free Onboarding
              <ArrowRight className="w-5 h-5" />
            </motion.a>
