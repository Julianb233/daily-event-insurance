...
export default function SalesDashboardForClient({ stats, partners, referralCode }: SalesDashboardProps) {
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <p className="text-2xl font-bold text-gray-900">${stats.lifetimeCommission.toFixed(2)}</p>
                </div>
            </div>
