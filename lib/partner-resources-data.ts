...
export const ADMIN_DEMO_RESOURCES: PartnerResource[] = [
  ...
  },
  {
    ...
    category: "marketing",
    resourceType: "image",
    fileUrl: "/resources/social-media-templates.zip",
  ...
  },
  {
    ...
    category: "marketing",
    resourceType: "pdf",
    fileUrl: "/resources/flyer-templates.pdf",
  ...
  // Training Resources
  {
    ...
    description: "Step-by-step video walkthrough for integrating the insurance widget on your website. Covers HTML embed, React/Next.js integration, and customization options.",
    category: "training",
    resourceType: "video",
    fileUrl: "https://www.youtube.com/watch?v=widget-integration",
  ...
  },
  {
    ...
    category: "training",
    resourceType: "pdf",
    fileUrl: "/resources/selling-best-practices.pdf",
  ...
  },
  {
    ...
    category: "training",
    resourceType: "video",
    fileUrl: "https://www.youtube.com/watch?v=coverage-options",
  ...
  },
  {
    ...
    category: "training",
    resourceType: "pdf",
    fileUrl: "/resources/faq-cheatsheet.pdf",
  ...
  },
  {
    ...
    description: "Video tutorial on how to help customers file claims and what to expect during the claims process. Includes timeline expectations and documentation requirements.",
    category: "training",
    resourceType: "video",
    fileUrl: "https://www.youtube.com/watch?v=claims-process",
  ...
  },
  {
    ...
    category: "documentation",
    resourceType: "pdf",
    fileUrl: "/resources/commission-guide.pdf",
  ...
  },
  {
    ...
    category: "documentation",
    resourceType: "pdf",
    fileUrl: "/resources/partner-terms.pdf",
  ...
  },
  {
    ...
    category: "documentation",
    resourceType: "pdf",
    fileUrl: "/resources/compliance-guide.pdf",
  ...
  },
  {
    ...
    category: "documentation",
    resourceType: "pdf",
    fileUrl: "/resources/troubleshooting-guide.pdf",
